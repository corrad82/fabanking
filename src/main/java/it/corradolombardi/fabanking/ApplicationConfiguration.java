...
import it.corradolombardi.fabanking.moneytransfer.ApiClientMoneyTransferRepository;
import it.corradolombardi.fabanking.moneytransfer.MoneyTransferRepository;
...
public class ApplicationConfiguration {
    ...
    @Bean
    public MoneyTransferRepository moneyTransferRepository(FabrikClient fabrikClient) {
        return new ApiClientMoneyTransferRepository(fabrikClient);
    }
    @Bean
